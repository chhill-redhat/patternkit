...
use Drupal\patternkit\Service\PatternLibraryMigrations;
...
class PatternkitCommands extends DrushCommands {
  ...
  /**
   * @var \Drupal\patternkit\Service\PatternLibraryMigrations
   */
  protected PatternLibraryMigrations $migrationsService;

  /**
   * Constructs the Patternkit Drush Commands functionality.
   */
  public function __construct(PatternLibraryMigrations $migrations_service) {
    parent::__construct();
    ...
    $this->migrationsService = $migrations_service;
  }
  ...
  public function libUpdate() {
    $this->migrationsService->doLibraryUpdates();
  }
